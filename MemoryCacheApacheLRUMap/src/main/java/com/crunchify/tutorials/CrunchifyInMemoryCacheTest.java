...
public class CrunchifyInMemoryCacheTest {
	...
	private void crunchifyTestAddRemoveObjects() {
		...
		System.out.println("6 Cache Objects Added.. cache.size(): " + cache.size());
		cache.remove("IBM");
		System.out.println("One Object Added.. cache.size(): " + cache.size());
	...
	private void crunchifyTestExpiredCacheObjects() throws InterruptedException {
		...
		// crunchifyTimeInterval = 1 second
		// maxItems = 10
	...
	private void crunchifyTestObjectsCleanupTime() throws InterruptedException {
		...
		System.out.println("Clean times for " + size + " objects are " + finish + " s");
